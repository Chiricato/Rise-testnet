...
LANG = {
    'vi': {
        'title': 'DEPLOY TOKEN ERC20 - RISE TESTNET',
        'info': 'Thông tin',
        'found': 'Tìm thấy',
        'wallets': 'ví',
        'processing_wallet': 'XỬ LÝ VÍ',
        'enter_name': 'Nhập tên token (VD: Thog Token):',
        'enter_symbol': 'Nhập ký hiệu token (mặc định ETH):',
    ...
    'en': {
        'title': 'DEPLOY ERC20 TOKEN - RISE TESTNET',
        'info': 'Info',
        'found': 'Found',
        'wallets': 'wallets',
        'processing_wallet': 'PROCESSING WALLET',
        'enter_name': 'Enter token name (e.g., Thog Token):',
        'enter_symbol': 'Enter token symbol (default ETH):',
